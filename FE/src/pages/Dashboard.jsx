    ...
    <div className="flex h-screen bg-[#f8f9fa] font-sans text-[#191c1d] overflow-hidden">
      ...
      <aside className="w-64 flex flex-col p-6 space-y-8 bg-[#f8f9fa]">
        ...
        <nav className="flex flex-col gap-2 flex-1">
          ...
          <a href="/dashboard" className="flex items-center gap-3 px-4 py-3 rounded-xl bg-blue-50 text-blue-700 font-semibold transition-colors">
      ...
      <main className="flex-1 flex flex-col bg-[#f8f9fa] overflow-y-auto px-8 py-6">
        ...
        <header className="flex justify-between items-center mb-10">
          <div>
            <h2 className="text-2xl font-bold tracking-tight">{getGreeting()}, Kỹ sư!</h2>
        ...
        <section>
          <div className="flex justify-between items-center mb-6">
            ...
            <button onClick={handleViewAll} className="text-sm text-blue-600 font-medium hover:underline">Xem tất cả</button>
          </div>
